...
根据ProcessingTime处理Stream相对简单，这里我们着重讨论下根据EventTime处理Stream时的情况，这是绝大多数业务场景需要解决的问题。
  ...
  ![](https://bbhhhh.github.io/img/flink-20200424111935.png)
     ...
     根据上面的watermark算法
         -  当系统时间走到T(8)时，watermark为wt(5)，大于等于w(5)，w[0-5)窗口关闭条件满足，此时虽然e(4)尚未到达，但仍然会关闭window并对 e(1),e(3)开始计算。
         -  此时收到延迟到达的e(4)，由于w[0-5)已经关闭，该事件将被抛弃。
         -  当系统时间走到T(13)时，watermark为wt(10)，大于等于w(10)，w[5-10)窗口关闭条件满足，w(10)关闭并对 e(6)开始计算。
         -  以此类推
...
![](https://bbhhhh.github.io/img/flink-20200424112016.png)
     ...
     w[10-15)窗口应该包含e(12),e(14)
     根据上面的watermark算法
         -  当收到e(3)，watermark为wt(0)，收到e(6)，watermark为wt(3)。
         -  收到e(4)后，根据算法，watermark保持不变，仍旧为wt(3)，由于w[0-5)尚未关闭，可以加入该窗口。
         -  收到e(12)，watermark为wt(9)， 大于等于w(5)，w[0-5)窗口关闭条件满足，对e(1),e(3),e(4)进行计算。
         -  收到e(14)，watermark为wt(11)， 大于等于w(10)，w[5-10)窗口关闭条件满足，对e(6)进行计算。
         -  以此类推
